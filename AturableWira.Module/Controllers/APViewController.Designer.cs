namespace AturableWira.Module.Controllers
{
    partial class APViewController
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.PostAPPaymentAction = new DevExpress.ExpressApp.Actions.SimpleAction(this.components);
            // 
            // CreateInvoiceAction
            // 
            ...
            this.CreateInvoiceAction.TargetObjectsCriteria = "[APInvoice] is null";
    ...
    "ipt to adjust.\r\nAre you sure want to post selected receipts?\r\n";
            ...
            this.PostOrderReceipt.TargetObjectsCriteria = "Posted=false";
    ...
    "\nAre you sure want to continue?\r\n";
            ...
            // PostAPPaymentAction
            // 
            this.PostAPPaymentAction.Caption = "Post";
            this.PostAPPaymentAction.ConfirmationMessage = "All selected AP Payments will be posted an JVs will be created.\r\nDo you want to c" +
    "ontinue?";
            this.PostAPPaymentAction.Id = "PostAPPaymentAction";
            this.PostAPPaymentAction.TargetObjectsCriteria = "";
            this.PostAPPaymentAction.TargetObjectsCriteriaMode = DevExpress.ExpressApp.Actions.TargetObjectsCriteriaMode.TrueForAll;
            this.PostAPPaymentAction.TargetObjectType = typeof(AturableWira.Module.BusinessObjects.ACC.AP.APPayment);
            this.PostAPPaymentAction.ToolTip = null;
            this.PostAPPaymentAction.Execute += new DevExpress.ExpressApp.Actions.SimpleActionExecuteEventHandler(this.PostAPPaymentAction_Execute);
            // 
            // APViewController
            // 
            ...
            this.Actions.Add(this.PostAPPaymentAction);
      ...
      private DevExpress.ExpressApp.Actions.SimpleAction PostAPPaymentAction;
   }
}
